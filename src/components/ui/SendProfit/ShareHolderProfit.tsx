  ...
  const fetchShareHolderHistories = async () => {
    try {
      ...
      const response = await axios.get(
        `${baseUrl}/wallet/share-holder?date=${formatDate2(value)}`,
        {
          headers: {
      ...
      <div className="col-span-2 rounded-md py-5 bg-white">
        ...
        <div className="px-5">
          <div className="text-sm">
            Send Share holder Profit to Investors on{" "}
              ...
              {isLoading ? (
                ...
                histories.map((detail, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">{detail.share_holder_amount}</td>
                    <td className="px-6 py-4">
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setPaymentAmount({
                              ...
                              value: {
                                _id: detail._id,
                                share_holder_amount: detail.share_holder_amount,
