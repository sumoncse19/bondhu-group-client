  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 w-full">
      ...
      <div className="col-span-1 flex flex-col gap-4 p-0 lg:p-2">
          ...
          <div className="flex flex-col my-4">
            <div className="flex items-center justify-between border-b border-gray-300 py-2">
              <div className="flex flex-col gap-1">
                <p>Project Share</p>
                <p className="text-gray-700 text-xs">#bhgh112</p>
              </div>
              <div className="text-green-700">$122.12</div>
            </div>
            <div className="flex items-center justify-between border-b border-gray-300 py-2">
              <div className="flex flex-col gap-1">
                <p>Partnership</p>
            ...
            <div className="flex items-center justify-between border-b border-gray-300 py-2">
              ...
              <div className="text-green-700">$4532.12</div>
            </div>
            <div className="flex items-center justify-between border-b border-gray-300 py-2">
              <div className="flex flex-col gap-1">
                <p>Partnership</p>
                <p className="text-gray-700 text-xs">#lkhh23</p>
              </div>
              <div className="text-green-700">$891.12</div>
            </div>
            <div className="flex items-center justify-between border-b border-gray-300 py-2">
              <div className="flex flex-col gap-1">
                <p>Fixed Deposit</p>
              ...
              <div className="text-green-700">$1221.12</div>
            </div>
          </div>
        </div>
        ...
        <DonutChart
          percentage={
            user?.wallet ? parseInt(user.wallet.purchase_wallet ?? 0) / 1000 : 0
          }
